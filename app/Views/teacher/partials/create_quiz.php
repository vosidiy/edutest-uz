<dialog class="dialog app-dialog" id="create-quiz-dialog" aria-labelledby="create-quiz-title">
    <form method="dialog" data-create-form>
        <div class="dialog-heading"><div><p class="eyebrow">New draft</p><h2 id="create-quiz-title">Create a quiz</h2></div><button class="btn btn-default btn-icon" value="cancel" aria-label="Close">×</button></div>
        <p class="dialog-copy">Choose the starting mode. You can change it until the first student starts.</p>
        <label class="form-field"><span class="form-label">Quiz title</span><input class="form-control" name="title" maxlength="200" required autocomplete="off" placeholder="e.g. Algebra midterm"></label>
        ...
        <div class="dialog-actions"><button class="btn btn-default" value="cancel">Cancel</button><button class="btn btn-primary" type="submit" value="default">Create draft</button></div>
    </form>
</dialog>
